<template>
    <section class="doubleLayout">
        <b-container v-if="!this.isProduct">
            <b-row>
                    ...
                    <aside>
                        <div class="sidebarContent">
                            <div class="content text-lg-left text-md-center text-left">
                                <h3>order summary</h3>
                                <p class="active"><font-awesome-icon :icon="['fa', 'info-circle']" class="mr-2"/> Just $20 away from free shipping.</p>
                            ...
                            <div class="productSelected">
                                <div class="singleProduct">
                                    ...
                                    <div class="singleDesc">
                                        ...
                                        <h5 class="title">100% natural premium clumping litter</h5>
                                        <h5>Size: 20lb</h5>
                    ...
                    <aside>
                        <b-col md="10">
                            <div class="sidebarContent">
                                <div class="content text-lg-left text-md-center text-left">
                                    <h3>order summary</h3>
                                    <p class="active"><font-awesome-icon :icon="['fa', 'check-square']" class="mr-2"/> You qualify for free shipping!</p>
                                    <div class="summary">
                                        ...
                                        <p class="text-center bold text-uppercase small"><NuxtLink to="/">Continue to shopping</NuxtLink></p>
