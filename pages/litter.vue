<template>
    <main>
            ...
            <template slot="sliderSection">
                <div class="sliderThumbnail">
                    <slick :options="sliderNav" ref="sliderSecondary" @beforeChange="syncSliders">
                        <div class="imgContainer"><b-img fluid src="~/assets/images/litter3.png"></b-img></div>
                        <div class="imgContainer"><b-img fluid src="~/assets/images/litter4.png"></b-img></div>
                        <div class="imgContainer"><b-img fluid src="~/assets/images/product1.png"></b-img></div>
                        <div class="imgContainer"><b-img fluid src="~/assets/images/litter1.png"></b-img></div>
                        <div class="imgContainer"><b-img fluid src="~/assets/images/litter2.png"></b-img></div>
                        <div class="imgContainer"><b-img fluid src="~/assets/images/litter3.png"></b-img></div>
                    </slick>
                </div>
        ...
        <LitterSellProductDescription>
            <template slot="galleryPhotos">
                <slick :options="galleryPhotos">
                    <div class="imgContainer"><b-img src="~assets/images/litter_1.png" fluid alt="photo1"></b-img></div>
                    <div class="imgContainer"><b-img src="~assets/images/litter_2.png" fluid alt="photo2"></b-img></div>
                </slick>
            </template>
        </LitterSellProductDescription>
        <PopularProducts>
